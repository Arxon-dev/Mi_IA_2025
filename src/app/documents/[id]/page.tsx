...
// Deshabilitar prerenderizado estático para esta página dinámica
...
export default function DocumentPage() {
  ...
  const [questionsViewMode, setQuestionsViewMode] = useState<'gift' | 'moodle'>('gift');
  ...
  // Cargar configuraciones de localStorage después del montaje
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const storedRightPanel = localStorage.getItem('showRightPanel');
      if (storedRightPanel !== null) {
        setShowRightPanel(storedRightPanel === 'true');
      }
      
      const storedViewMode = localStorage.getItem('questionsViewMode');
      if (storedViewMode) {
        setQuestionsViewMode(storedViewMode as 'gift' | 'moodle');
      }
    }
  }, []);
