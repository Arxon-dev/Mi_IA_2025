 ...
 */
export async function handleVincularMoodleCommand(userid: string, fromtelegramuser: any): Promise<string | null> {
  try {
 ...
 */
export async function handleEstadoMoodleCommand(userid: string, fromtelegramuser: any): Promise<string | null> {
  try {
 ...
 */
export async function handleEstadisticasUnificadasCommand(userid: string, fromtelegramuser: any): Promise<string | null> {
  try {
...
👤 <b>${fromtelegramuser.first_name || 'Usuario'}</b>
 ...
 */
export async function handleSincronizarMoodleCommand(userid: string, fromtelegramuser: any): Promise<string | null> {
  try {
 ...
 */
export async function handleCodigoMoodleCommand(userid: string, code: string, fromtelegramuser: any): Promise<string | null> {
  try {
...
💡 Genera un nuevo código en tu plataforma Moodle si es necesario.`;
    ...
    const verification = await MoodleGamificationService.verifyMoodleCode(code, userid, fromtelegramuser);
