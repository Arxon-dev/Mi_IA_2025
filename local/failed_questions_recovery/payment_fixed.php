...
try {
    ...
    $PAGE->set_url(new moodle_url('/local/failed_questions_recovery/payment_fixed.php'));
    $PAGE->set_title('Pago de Acceso a Recuperación de Preguntas Falladas');
    $PAGE->set_heading('Pago de Acceso a Recuperación de Preguntas Falladas');
    ...
    echo '<h3>Pago de Acceso a Recuperación de Preguntas Falladas</h3>';
    echo '</div>';
    echo '<div class="card-body">';
    echo '<div id="payment-message"></div>';
    echo '<div id="payment-container">';
    echo '<p>Para acceder a la funcionalidad de recuperación de preguntas falladas, necesita realizar un pago de <strong>6.00 EUR</strong>.</p>';
